...
Object.defineProperty(q, "extend", {
  ...
  enumerable: false,
  configurable: true,
  value: function(objetoIn) {
    var names = Object.getOwnPropertyNames(objetoIn);
    names.forEach(element => {
      console.log(element);
      if (element in this) return;
      console.log("guardo la propiedad ' " + element + " ' en el objeto q");
      Object.defineProperty(
        this,
        element,
        Object.getOwnPropertyDescriptor(objetoIn, element)
      );
    });
  },
  enumerable: false
